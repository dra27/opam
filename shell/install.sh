...
bin_sha512() {
  case "$OPAM_BIN" in
    ...
    opam-$TAG-armhf-linux)     echo "85e6f9a44a0f86a2695fa5ecf1ef31c2f439298ce67a564b735272d9c5d735d93428b0d47cd53e4774027893366717c6a03f85c4cbefed3c720448406cbdc12";;
